class ClinicsController < ApplicationController
  ...
  def authenticate
    @clinic =  Clinic.find_by_email('miami@cardiology.com')#Clinic.find_by_authentication_token(request.headers['X-TOKEN'])#Clinic.find_by_email('miami@cardiology.com')
